...
<div class="header changes-header">
    ...
    <nav class="header-nav">
        ...
        <button class="nav-btn help-nav-btn" onclick="document.getElementById('changeHelpModal').classList.add('active')" title="Help">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<!-- Change Management Help Modal -->
<div class="cm-help-overlay" id="changeHelpModal">
    <div class="cm-help-modal">
        <button class="cm-help-close" onclick="document.getElementById('changeHelpModal').classList.remove('active')">&times;</button>
        ...
        <div class="cm-help-scroll">
            ...
            <!-- Section 5: CAB -->
            <div class="cm-help-section cm-help-section-highlight">
                <div class="cm-help-section-header">
